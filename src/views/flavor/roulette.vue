<template>
  ...
  <div class="min-h-screen-content bg-cover bg-no-repeat bg-center pt-6 md:pt-20" :style="{backgroundImage: 'url(/img/fondo.svg)'}">
    <img class="w-60 md:w-96 mx-auto" src="../../assets/lemondanger/gira-la-ruleta.svg" alt="gira la ruleta" />
    <img class="w-60 md:w-96 mx-auto" src="../../assets/lemondanger/gato-tranki.svg" alt="gato tranki" />
