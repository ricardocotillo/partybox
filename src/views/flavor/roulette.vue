<template>
  ...
  <div class="min-h-screen-content bg-cover bg-no-repeat bg-center pt-6 md:pt-20 -mt-1" :style="{backgroundImage: 'url(/img/fondo.svg)'}">
    ...
    <div class="grid grid-cols-1 grid-rows-1 place-content-center place-items-center w-72 mx-auto -mt-5 md:w-120 md:-mt-7" @click="showDare = false">
      <img
        ref="roulette"
      ...
      />
      <img
        class="w-24 -mt-4 col-start-1 row-start-1 col-span-1 row-span-1 z-10 md:w-40 cursor-pointer"
